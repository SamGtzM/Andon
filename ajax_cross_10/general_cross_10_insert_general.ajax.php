...
class Ajaxinsertgen_cross_10{
    ...
    public function ajaxAgregarLike_cross_10(){
        $datos = array(
        ...
        $respuesta = ControladorCross_10::ctr_insert_gen_cross_10($datos);
        echo $respuesta;
    }
...
if (isset($_POST["are"])) {
    $deseo = new Ajaxinsertgen_cross_10();
    ...
    $deseo -> ajaxAgregarLike_cross_10();
}