...
class Ajaxinsertgen_eje_60{
    ...
    public function ajaxAgregarLike_eje_60(){
        $datos = array(
        ...
        $respuesta = ControladorEje_60::ctr_insert_gen_eje_60($datos);
        echo $respuesta;
    }
...
if (isset($_POST["are"])) {
    $deseo = new Ajaxinsertgen_eje_60();
