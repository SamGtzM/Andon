...
class Ajaxinsertgen_cross_50{
    ...
    public function ajaxAgregarLike_cross_50(){
        $datos = array(
        ...
        $respuesta = ControladorCross_50::ctr_insert_gen_cross_50($datos);
        echo $respuesta;
    }
...
if (isset($_POST["are"])) {
    $deseo = new Ajaxinsertgen_cross_50();
    ...
    $deseo -> ajaxAgregarLike_cross_50();
}