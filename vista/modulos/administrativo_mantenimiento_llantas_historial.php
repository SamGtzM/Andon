...
<div class="back_administrativo_tables">
    ...
    <table id="table_id_administrativos mttollantastablehist" class="table table-striped table-bordered mttollantastablehist" style="width:100%">
        <thead>
            <tr>
                <th> Area </th>
                <th> OP </th>
        ...
        <tbody>       
            <?php
                ...
                $valor = ControladorAdministrativo::ctrAdministrativoMttoHL();
