...
<div class="back_administrativo_tables">
    ...
    <table id="table_id_administrativos callantashistorial" class="table table-striped table-bordered callantashistorial" style="width:100%">
        <thead>
            <tr>
                <th> Area </th>
                <th> OP </th>
        ...
        <tbody>       
            <?php
                ...
                $valor = ControladorAdministrativo::ctrAdministrativoCalidadHL();
