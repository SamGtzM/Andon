...
<div class="back_administrativo_tables">
    ...
    <table id="table_id_administrativos prodllantastableactivos" class="table table-striped table-bordered prodllantastableactivos" style="width:100%">
        <thead>
            <tr>
                <th> Area </th>
                <th> OP </th>
        ...
        <tbody>       
            <?php
                ...
                $valor = ControladorAdministrativo::ctrAdministrativoProdL();
                    ...
                    foreach (@$valor["id_paro"] as $value) {
                        ...
                        <tr>';
                            ...
                            if(@$valor["final_paro"][$i] == "" || @$valor["final_paro"][$i] == NULL){
                                ...
                                echo'<td><button class="btn-primary btn_consultar_rate tablecerrar btn_cerrar_paro_prod_l" idparo="'.@$valor["id_paro"][$i].'" data-toggle="modal" data-target="#exampleModal"> ❌ </button></td>';
                            }
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content"><br>
      ...
      <div class="form-wrapper">
        ...
        <form method="POST" class="form" id="cerrarparopl" name="cerrarparopl">
            <center>

            <input type="hidden" id="idparopl" name="idparopl">
            ...
            <div class="form-group">
                ...
                <?php
                    ...
                    $cierreParo -> ctrAdministrativoProdLlantasCerrarParo();
