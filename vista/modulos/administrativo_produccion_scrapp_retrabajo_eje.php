    ...
    <table id="table_id_administrativos scrappeje" class="table table-striped table-bordered scrappeje" style="width:100%">
        ...
        <tbody>       
			<?php
				...
				$valor = ControladorAdministrativo::ctr_prod_scrapp_eje();
				...
				if(@$valor != '' || @$valor != null){
					...
					foreach (@$valor["id"] as $value) {
						...
						<tr>
                            ...
                            <td><button class="btn-primary btn_consultar_scrappeje" idscrappejeconsulta="'.@$valor["id"][$i].'" data-toggle="modal" data-target="#exampleModal"> 🗒 </button></td>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content"><br>
      ...
      <div class="form-wrapper">
        ...
        <form method="POST" class="form" id="llenaridscrappe" name="llenaridscrappe">
            <center>

            <input type="hidden" id="idscrappe" name="idscrappe">
            ...
            <div class="form-group">
                ...
                <?php
                    ...
                    $ingresarscrapp -> ctr_registrar_scrapp_eje();
