...
<div class="back_administrativo_tables">
    ...
    <table id="table_id_administrativos mttocrosstableactivos" class="table table-striped table-bordered mttocrosstableactivos" style="width:100%">
        <thead>
            <tr>
                <th> Area </th>
                <th> OP </th>
        ...
        <tbody>       
            <?php
                ...
                $valor = ControladorAdministrativo::ctrAdministrativoMttoC();
                    ...
                    foreach (@$valor["id_paro"] as $value) {
                        ...
                        <tr>';
                            ...
                            if(@$valor["final_paro"][$i] == "" || @$valor["final_paro"][$i] == NULL){
                                ...
                                echo'<td><button class="btn-primary btn_consultar_rate tablecerrar btn_cerrar_paro" idparo="'.@$valor["id_paro"][$i].'" data-toggle="modal" data-target="#exampleModal"> ❌ </button></td>';
                            }
...
<!-- Modal -->
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">idusuariomodif
  <div class="modal-dialog" role="document">
    <div class="modal-content"><br>
      ...
      <div class="form-wrapper">
        ...
        <form method="POST" class="form" id="cerrarparo" name="cerrarparo">
            <center>

            <input type="hidden" id="idparomc" name="idparomc">
            ...
            <div class="form-group">
                ...
                <?php
                    ...
                    $cierreParo -> ctrAdministrativoMttoCrossCerrarParo();
