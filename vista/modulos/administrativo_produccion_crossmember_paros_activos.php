...
<div class="back_administrativo_tables">
    ...
    <table id="table_id_administrativos prodcrosstableactivos" class="table table-striped table-bordered prodcrosstableactivos" style="width:100%">
        <thead>
            <tr>
                <th> Area </th>
                <th> OP </th>
        ...
        <tbody>       
            <?php
                ...
                $valor = ControladorAdministrativo::ctrAdministrativoProdC();
                    ...
                    foreach (@$valor["id_paro"] as $value) {
                        ...
                        <tr>';
                            ...
                            if(@$valor["final_paro"][$i] == "" || @$valor["final_paro"][$i] == NULL){
                                ...
                                echo'<td><button class="btn-primary btn_consultar_rate tablecerrar btn_cerrar_paro_prod_c" idparo="'.@$valor["id_paro"][$i].'" data-toggle="modal" data-target="#exampleModal"> ❌ </button></td>';
                            }
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content"><br>
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel"> Close stop </h5>
      ...
      <div class="form-wrapper">
        ...
        <form method="POST" class="form" id="cerrarparopc" name="cerrarparopc">
            <center>

            <input type="hidden" id="idparopc" name="idparopc">
            ...
            <div class="form-group">
                ...
                <?php
                    ...
                    $cierreParo -> ctrAdministrativoProdCrossCerrarParo();
