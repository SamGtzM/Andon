...
class Ajaxinsertgen_cross_30{
    ...
    public function ajaxAgregarLike_cross_30(){
        $datos = array(
        ...
        $respuesta = ControladorCross_30::ctr_insert_gen_cross_30($datos);
        echo $respuesta;
    }
...
if (isset($_POST["are"])) {
    $deseo = new Ajaxinsertgen_cross_30();
    ...
    $deseo -> ajaxAgregarLike_cross_30();
}