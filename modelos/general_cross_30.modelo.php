...
class ModeloCross_30{

    static public function mdl_cross_30($tabla){

        $stmt = Conexion::conectar() -> prepare("SELECT $tabla.id_status_crossmember_30, $tabla.status_crossmember_30_mantenimiento, $tabla.status_crossmember_30_calidad, $tabla.status_crossmember_30_produccion, $tabla.status_crossmember_30_logistica, $tabla.inicio_ciclo_crossmember_30, $tabla.fin_ciclo_crossmember_30, convert(varchar(19),$tabla.inicio_paro_crossmember_30_mantenimiento,121) as inicio_paro_crossmember_30_mantenimiento, convert(varchar(19),$tabla.inicio_paro_crossmember_30_calidad,121) as inicio_paro_crossmember_30_calidad, convert(varchar(19),$tabla.inicio_paro_crossmember_30_produccion,121) as inicio_paro_crossmember_30_produccion, convert(varchar(19),$tabla.inicio_paro_crossmember_30_logistica,121) as inicio_paro_crossmember_30_logistica FROM $tabla WHERE id_status_crossmember_30 = (SELECT MAX($tabla.id_status_crossmember_30) FROM $tabla)");
        $stmt -> execute();
        foreach ($stmt as $row) {

            $respuesta["id_status_crossmember_30"][] = $row["id_status_crossmember_30"];
            $respuesta["status_crossmember_30_mantenimiento"][] = $row["status_crossmember_30_mantenimiento"];
            $respuesta["status_crossmember_30_calidad"][] = $row["status_crossmember_30_calidad"];
            $respuesta["status_crossmember_30_produccion"][] = $row["status_crossmember_30_produccion"];
            $respuesta["status_crossmember_30_logistica"][] = $row["status_crossmember_30_logistica"];
            $respuesta["inicio_ciclo_crossmember_30"][] = $row["inicio_ciclo_crossmember_30"];
            $respuesta["fin_ciclo_crossmember_30"][] = $row["fin_ciclo_crossmember_30"];
            $respuesta["inicio_paro_crossmember_30_mantenimiento"][] = $row["inicio_paro_crossmember_30_mantenimiento"];
            $respuesta["inicio_paro_crossmember_30_calidad"][] = $row["inicio_paro_crossmember_30_calidad"];
            $respuesta["inicio_paro_crossmember_30_produccion"][] = $row["inicio_paro_crossmember_30_produccion"];
            $respuesta["inicio_paro_crossmember_30_logistica"][] = $row["inicio_paro_crossmember_30_logistica"];
    ...
    static public function mdl_cross_30_producido_contador($tabla){

        $stmt = Conexion::conectar() -> prepare("SELECT
        (SELECT $tabla.acumulado_crossmember_30
        FROM $tabla
        WHERE id_status_crossmember_30 =
        (SELECT MAX($tabla.id_status_crossmember_30)
        FROM $tabla))as acumulado_crossmember_30,

    COUNT($tabla.fin_ciclo_crossmember_30) AS producido
    FROM $tabla
    WHERE $tabla.inicio_paro_fin_ciclo_crossmember_30 BETWEEN
        ...
        AND $tabla.fin_ciclo_crossmember_30 != '0' AND
        ...
        $tabla.inicio_paro_fin_ciclo_crossmember_30 BETWEEN
        (SELECT DATEADD(HOUR, DATEPART(HOUR, GETDATE()), CAST(CONVERT(VARCHAR(20), GETDATE(), 112) AS DATETIME))) AND
        ...
        foreach ($stmt as $row) {
            ...
            $respuesta["acumulado_crossmember_30"][] = $row["acumulado_crossmember_30"];
    ...
    static public function mdl_cross_30_acumulado_contador($tabla){
    ...
    static public function mdl_cross_30_turno($tabla){
    ...
    static public function mdl_insert_gen_cross_30($tabla, $datos){
    ...
    static public function mdl_cross_30_Prod_PrimerTurno_7_8($tabla){
    ...
    static public function mdl_cross_30_Prod_PrimerTurno_8_9($tabla){
    ...
    static public function mdl_cross_30_Prod_PrimerTurno_9_10($tabla){
    ...
    static public function mdl_cross_30_Prod_PrimerTurno_10_11($tabla){
    ...
    static public function mdl_cross_30_Prod_PrimerTurno_11_12($tabla){
    ...
    static public function mdl_cross_30_Prod_PrimerTurno_12_13($tabla){
    ...
    static public function mdl_cross_30_Prod_PrimerTurno_13_14($tabla){
    ...
    static public function mdl_cross_30_Prod_PrimerTurno_14_14_30($tabla){
    ...
    static public function mdl_cross_30_Prod_SegundoTurno_14_30_15($tabla){
    ...
    static public function mdl_cross_30_Prod_SegundoTurno_15_16($tabla){
    ...
    static public function mdl_cross_30_Prod_SegundoTurno_16_17($tabla){
    ...
    static public function mdl_cross_30_Prod_SegundoTurno_17_18($tabla){
    ...
    static public function mdl_cross_30_Prod_SegundoTurno_18_19($tabla){
    ...
    static public function mdl_cross_30_Prod_SegundoTurno_19_20($tabla){
    ...
    static public function mdl_cross_30_Prod_SegundoTurno_20_21($tabla){
    ...
    static public function mdl_cross_30_Prod_SegundoTurno_21_22($tabla){
    ...
    static public function mdl_cross_30_Prod_SegundoTurno_22_22_30($tabla){
    ...
    static public function mdl_cross_30_Prod_TercerTurno_22_30_23($tabla){
    ...
    static public function mdl_cross_30_Prod_TercerTurno_23_00($tabla){
    ...
    static public function mdl_cross_30_Prod_TercerTurno_00_01($tabla){
    ...
    static public function mdl_cross_30_Prod_TercerTurno_01_02($tabla){
    ...
    static public function mdl_cross_30_Prod_TercerTurno_02_03($tabla){
    ...
    static public function mdl_cross_30_Prod_TercerTurno_03_04($tabla){
    ...
    static public function mdl_cross_30_Prod_TercerTurno_04_05($tabla){
    ...
    static public function mdl_cross_30_Prod_TercerTurno_05_05_59($tabla){
    ...
    static public function mdl_acumulado_slide_primer_turno_cross_30($tabla){

        $stmt = Conexion::conectar() -> prepare("SELECT TOP 1 ($tabla.id), $tabla.acumuladas FROM $tabla WHERE $tabla.id_turno = '1' AND  $tabla.id_turno != '0'  AND $tabla.id_area = 3 AND $tabla.id_estacion = 7 order by id desc");
        $stmt -> execute();
        foreach ($stmt as $row) {
    ...
    static public function mdl_acumulado_slide_segundo_turno_cross_30($tabla){

        $stmt = Conexion::conectar() -> prepare("SELECT TOP 1 ($tabla.id), $tabla.acumuladas FROM $tabla WHERE $tabla.id_turno = '2' AND  $tabla.id_turno != '0'  AND $tabla.id_area = 3 AND $tabla.id_estacion = 7 order by id desc");
        $stmt -> execute();
        foreach ($stmt as $row) {
    ...
    static public function mdl_acumulado_slide_tercer_turno_cross_30($tabla){

        $stmt = Conexion::conectar() -> prepare("SELECT TOP 1 ($tabla.id), $tabla.acumuladas FROM $tabla WHERE $tabla.id_turno = '3' AND  $tabla.id_turno != '0'  AND $tabla.id_area = 3 AND $tabla.id_estacion = 7 order by id desc");
        $stmt -> execute();
        foreach ($stmt as $row) {
    ...
    static public function mdl_rateslide_primer_turno_cross_30($tabla){

        $stmt = Conexion::conectar() -> prepare("SELECT SUM($tabla.rate) AS rate FROM $tabla WHERE $tabla.rate_desde >= '06:00:00' AND  $tabla.rate_hasta <= '14:30:00' AND $tabla.id_area = 3 AND $tabla.id_estacion = 7");
        $stmt -> execute();
        foreach ($stmt as $row) {
    ...
    static public function mdl_rateslide_segundo_turno_cross_30($tabla){

        $stmt = Conexion::conectar() -> prepare("SELECT SUM($tabla.rate) AS rate FROM $tabla WHERE $tabla.rate_desde >= '14:30:00' AND  $tabla.rate_hasta <= '22:30:00' AND $tabla.id_area = 3 AND $tabla.id_estacion = 7");
        $stmt -> execute();
        foreach ($stmt as $row) {
    ...
    static public function mdl_status_mtto_1_cross_30($tabla){

        $stmt = Conexion::conectar() -> prepare("select top 1($tabla.id_status_crossmember_30), $tabla.status_crossmember_30_mantenimiento,
        $tabla.inicio_ciclo_crossmember_30, fin_ciclo_crossmember_30, convert(varchar(19), $tabla.inicio_paro_fin_ciclo_crossmember_30, 121) as inicio_paro_fin_ciclo_crossmember_30, $tabla.acumulado_crossmember_30,
        convert(varchar(19), $tabla.inicio_paro_crossmember_30_mantenimiento, 121) as inicio_paro_crossmember_30_mantenimiento
        from $tabla
        where $tabla.status_crossmember_30_mantenimiento = '1' and $tabla.fin_ciclo_crossmember_30 = '0'
        or $tabla.inicio_ciclo_crossmember_30 = '0' order by $tabla.id_status_crossmember_30 desc");
        $stmt -> execute();
        foreach ($stmt as $row) {
            ...
            $respuesta["inicio_ciclo_crossmember_30"][] = $row["inicio_ciclo_crossmember_30"];
            $respuesta["fin_ciclo_crossmember_30"][] = $row["fin_ciclo_crossmember_30"];
            $respuesta["inicio_paro_fin_ciclo_crossmember_30"][] = $row["inicio_paro_fin_ciclo_crossmember_30"];
            $respuesta["acumulado_crossmember_30"][] = $row["acumulado_crossmember_30"];
            $respuesta["inicio_paro_crossmember_30_mantenimiento"][] = $row["inicio_paro_crossmember_30_mantenimiento"];
            $respuesta["id"][] = "1";
    ...
    static public function mdl_status_mtto_0_cross_30($tabla){

        $stmt = Conexion::conectar() -> prepare("select top 1($tabla.id_status_crossmember_30), $tabla.status_crossmember_30_mantenimiento,
        $tabla.inicio_ciclo_crossmember_30, fin_ciclo_crossmember_30, convert(varchar(19), $tabla.inicio_paro_fin_ciclo_crossmember_30, 121) as inicio_paro_fin_ciclo_crossmember_30, $tabla.acumulado_crossmember_30,
        convert(varchar(19), $tabla.inicio_paro_crossmember_30_mantenimiento, 121) as inicio_paro_crossmember_30_mantenimiento
        from $tabla
        where $tabla.status_crossmember_30_mantenimiento = '0' and $tabla.fin_ciclo_crossmember_30 = '1'
        or $tabla.inicio_ciclo_crossmember_30 = '1' order by $tabla.id_status_crossmember_30 desc");
        $stmt -> execute();
        foreach ($stmt as $row) {
    ...
    static public function mdl_status_prod_1_cross_30($tabla){

        $stmt = Conexion::conectar() -> prepare("select top 1($tabla.id_status_crossmember_30), $tabla.status_crossmember_30_produccion,
        $tabla.inicio_ciclo_crossmember_30, $tabla.fin_ciclo_crossmember_30, convert(varchar(19), $tabla.inicio_paro_fin_ciclo_crossmember_30, 121) as inicio_paro_fin_ciclo_crossmember_30, $tabla.acumulado_crossmember_30,
        convert(varchar(19), $tabla.inicio_paro_crossmember_30_produccion, 121) as inicio_paro_crossmember_30_produccion
        from $tabla
        where $tabla.status_crossmember_30_produccion = '1' and $tabla.fin_ciclo_crossmember_30 = '0'
        and $tabla.inicio_ciclo_crossmember_30 = '0'  order by $tabla.id_status_crossmember_30 desc");
        $stmt -> execute();
        foreach ($stmt as $row) {
    ...
    static public function mdl_status_prod_0_cross_30($tabla){

        $stmt = Conexion::conectar() -> prepare("select top 1($tabla.id_status_crossmember_30), $tabla.status_crossmember_30_produccion,
        $tabla.inicio_ciclo_crossmember_30, $tabla.fin_ciclo_crossmember_30, convert(varchar(19), $tabla.inicio_paro_fin_ciclo_crossmember_30, 121) as inicio_paro_fin_ciclo_crossmember_30, $tabla.acumulado_crossmember_30,
        convert(varchar(19), $tabla.inicio_paro_crossmember_30_produccion, 121) as inicio_paro_crossmember_30_produccion
        from $tabla
        where $tabla.status_crossmember_30_produccion = '0' and $tabla.fin_ciclo_crossmember_30 = '1'
        OR $tabla.inicio_ciclo_crossmember_30 = '1'  order by $tabla.id_status_crossmember_30 desc");
        $stmt -> execute();
        foreach ($stmt as $row) {
    ...
    static public function mdl_status_cal_1_cross_30($tabla){

        $stmt = Conexion::conectar() -> prepare("select top 1($tabla.id_status_crossmember_30), $tabla.status_crossmember_30_calidad,
        $tabla.inicio_ciclo_crossmember_30, $tabla.fin_ciclo_crossmember_30, convert(varchar(19), $tabla.inicio_paro_fin_ciclo_crossmember_30, 121) as inicio_paro_fin_ciclo_crossmember_30, $tabla.acumulado_crossmember_30,
        convert(varchar(19), $tabla.inicio_paro_crossmember_30_calidad, 121) as inicio_paro_crossmember_30_calidad
        from $tabla
        where $tabla.status_crossmember_30_calidad = '1' and $tabla.fin_ciclo_crossmember_30 = '0'
        and $tabla.inicio_ciclo_crossmember_30 = '0'  order by $tabla.id_status_crossmember_30 desc");
        $stmt -> execute();
        foreach ($stmt as $row) {
    ...
    static public function mdl_status_cal_0_cross_30($tabla){

        $stmt = Conexion::conectar() -> prepare("select top 1($tabla.id_status_crossmember_30), $tabla.status_crossmember_30_calidad,
        $tabla.inicio_ciclo_crossmember_30, $tabla.fin_ciclo_crossmember_30, convert(varchar(19), $tabla.inicio_paro_fin_ciclo_crossmember_30, 121) as inicio_paro_fin_ciclo_crossmember_30, $tabla.acumulado_crossmember_30,
        convert(varchar(19), $tabla.inicio_paro_crossmember_30_calidad, 121) as inicio_paro_crossmember_30_calidad
        from $tabla
        where $tabla.status_crossmember_30_calidad = '0' and $tabla.fin_ciclo_crossmember_30 = '1'
        OR $tabla.inicio_ciclo_crossmember_30 = '1'  order by $tabla.id_status_crossmember_30 desc");
        $stmt -> execute();
        foreach ($stmt as $row) {
    ...
    static public function mdl_status_log_1_cross_30($tabla){

        $stmt = Conexion::conectar() -> prepare("select top 1($tabla.id_status_crossmember_30), $tabla.status_crossmember_30_logistica,
        $tabla.inicio_ciclo_crossmember_30, $tabla.fin_ciclo_crossmember_30, convert(varchar(19), $tabla.inicio_paro_fin_ciclo_crossmember_30, 121) as inicio_paro_fin_ciclo_crossmember_30, $tabla.acumulado_crossmember_30,
        convert(varchar(19), inicio_paro_crossmember_30_logistica, 121) as inicio_paro_crossmember_30_logistica
        from $tabla
        where $tabla.status_crossmember_30_logistica = '1' and $tabla.fin_ciclo_crossmember_30 = '0'
        and $tabla.inicio_ciclo_crossmember_30 = '0'  order by $tabla.id_status_crossmember_30 desc");
        $stmt -> execute();
        foreach ($stmt as $row) {
    ...
    static public function mdl_status_log_0_cross_30($tabla){

        $stmt = Conexion::conectar() -> prepare("select top 1($tabla.id_status_crossmember_30), $tabla.status_crossmember_30_logistica,
        $tabla.inicio_ciclo_crossmember_30, $tabla.fin_ciclo_crossmember_30, convert(varchar(19), $tabla.inicio_paro_fin_ciclo_crossmember_30, 121) as inicio_paro_fin_ciclo_crossmember_30, $tabla.acumulado_crossmember_30,
        convert(varchar(19), $tabla.inicio_paro_crossmember_30_logistica, 121) as inicio_paro_crossmember_30_logistica
        from $tabla
        where $tabla.status_crossmember_30_logistica = '0' and $tabla.fin_ciclo_crossmember_30 = '1'
        OR $tabla.inicio_ciclo_crossmember_30 = '1'  order by $tabla.id_status_crossmember_30 desc");
        $stmt -> execute();
        foreach ($stmt as $row) {
    ...
    static public function mdl_insert_paro_status_mtto_1_cross_30($tabla, $datos){
    ...
    static public function mdl_insert_paro_status_mtto_0_cross_30($tabla, $datos){
    ...
    static public function mdl_insert_paro_status_prod_1_cross_30($tabla, $datos){
        $stmt = Conexion::conectar() -> prepare("INSERT INTO $tabla (activo_status, id_departamento_paro, id_area, id_estacion, id_turno, rate, producido, OEE, acumuladas, inicio_paro, fecha_alta) VALUES (:activo_status, :id_departamento_paro, :id_area, :id_estacion, :id_turno, :rate, :producido, :OEE, :acumuladas, :inicio_paro, :fecha_alta)");
        $stmt -> bindParam(":activo_status", $datos["activo_status"], PDO::PARAM_INT);
        $stmt -> bindParam(":id_departamento_paro", $datos["id_departamento_paro"], PDO::PARAM_INT);
        $stmt -> bindParam(":id_area", $datos["id_area"], PDO::PARAM_INT);
    ...
    static public function mdl_insert_paro_status_prod_0_cross_30($tabla, $datos){
    ...
    static public function mdl_insert_paro_status_cal_1_cross_30($tabla, $datos){
        $stmt = Conexion::conectar() -> prepare("INSERT INTO $tabla (activo_status, id_departamento_paro, id_area, id_estacion, id_turno, rate, producido, OEE, acumuladas, inicio_paro, fecha_alta) VALUES (:activo_status, :id_departamento_paro, :id_area, :id_estacion, :id_turno, :rate, :producido, :OEE, :acumuladas, :inicio_paro, :fecha_alta)");
        $stmt -> bindParam(":activo_status", $datos["activo_status"], PDO::PARAM_INT);
        $stmt -> bindParam(":id_departamento_paro", $datos["id_departamento_paro"], PDO::PARAM_INT);
        $stmt -> bindParam(":id_area", $datos["id_area"], PDO::PARAM_INT);
    ...
    static public function mdl_insert_paro_status_cal_0_cross_30($tabla, $datos){
    ...
    static public function mdl_insert_paro_status_log_1_cross_30($tabla, $datos){
        $stmt = Conexion::conectar() -> prepare("INSERT INTO $tabla (activo_status, id_departamento_paro, id_area, id_estacion, id_turno, rate, producido, OEE, acumuladas, inicio_paro, fecha_alta) VALUES (:activo_status, :id_departamento_paro, :id_area, :id_estacion, :id_turno, :rate, :producido, :OEE, :acumuladas, :inicio_paro, :fecha_alta)");
        $stmt -> bindParam(":activo_status", $datos["activo_status"], PDO::PARAM_INT);
        $stmt -> bindParam(":id_departamento_paro", $datos["id_departamento_paro"], PDO::PARAM_INT);
        $stmt -> bindParam(":id_area", $datos["id_area"], PDO::PARAM_INT);
    ...
    static public function mdl_insert_paro_status_log_0_cross_30($tabla, $datos){
    ...
    static public function mdl_mtto_correo_inf_cross_30($tabla){
    ...
    static public function mdl_prod_correo_inf_cross_30($tabla){
    ...
    static public function mdl_cal_correo_inf_cross_30($tabla){
    ...
    static public function mdl_log_correo_inf_cross_30($tabla){
    ...
    static public function mdl_cross_30_status_PrimerTurno_7_8($tabla){
    ...
    static public function mdl_cross_30_status_PrimerTurno_8_9($tabla){
    ...
    static public function mdl_cross_30_status_PrimerTurno_9_10($tabla){

        $stmt = Conexion::conectar() -> prepare("Select top 1 ($tabla.id_paro) ,$tabla.id_departamento_paro, datediff ( ss, $tabla.inicio_paro , $tabla.final_paro) as diferencia from $tabla where $tabla.fecha_alta BETWEEN (SELECT CONCAT((SELECT CONVERT(VARCHAR(10), SYSDATETIME())), ' ' ,('09:00:00.000'))) AND (SELECT CONCAT((SELECT CONVERT(VARCHAR(10), SYSDATETIME())), ' ' ,('09:59:59.000'))) AND $tabla.id_area = 3 AND $tabla.id_estacion = 7 AND $tabla.id_turno = 5  AND $tabla.final_paro != '' OR $tabla.final_paro != NULL order by diferencia desc");
        $stmt -> execute();
        foreach ($stmt as $row) {
    ...
    static public function mdl_cross_30_status_PrimerTurno_10_11($tabla){
    ...
    static public function mdl_cross_30_status_PrimerTurno_11_12($tabla){
    ...
    static public function mdl_cross_30_status_PrimerTurno_12_13($tabla){
    ...
    static public function mdl_cross_30_status_PrimerTurno_13_14($tabla){
    ...
    static public function mdl_cross_30_status_PrimerTurno_14_14_30($tabla){
    ...
    static public function mdl_cross_30_status_SegundoTurno_14_30_15($tabla){

        $stmt = Conexion::conectar() -> prepare("Select top 1 ($tabla.id_paro) ,$tabla.id_departamento_paro, datediff ( ss, $tabla.inicio_paro , $tabla.final_paro) as diferencia from $tabla where $tabla.fecha_alta BETWEEN (SELECT CONCAT((SELECT CONVERT(VARCHAR(10), SYSDATETIME())), ' ' ,('14:30:00.000'))) AND (SELECT CONCAT((SELECT CONVERT(VARCHAR(10), SYSDATETIME())), ' ' ,('14:59:59.000'))) AND $tabla.id_area = 3 AND $tabla.id_estacion = 7 AND $tabla.id_turno = 2  AND $tabla.final_paro != '' OR $tabla.final_paro != NULL order by diferencia desc");
        $stmt -> execute();
        foreach ($stmt as $row) {
    ...
    static public function mdl_cross_30_status_SegundoTurno_15_16($tabla){
    ...
    static public function mdl_cross_30_status_SegundoTurno_16_17($tabla){
    ...
    static public function mdl_cross_30_status_SegundoTurno_17_18($tabla){
    ...
    static public function mdl_cross_30_status_SegundoTurno_18_19($tabla){
    ...
    static public function mdl_cross_30_status_SegundoTurno_19_20($tabla){
    ...
    static public function mdl_cross_30_status_SegundoTurno_20_21($tabla){
    ...
    static public function mdl_cross_30_status_SegundoTurno_21_22($tabla){
    ...
    static public function mdl_cross_30_status_SegundoTurno_22_22_30($tabla){
    ...
    static public function mdl_cross_30_status_TercerTurno_22_30_23($tabla){

        $stmt = Conexion::conectar() -> prepare("Select top 1 ($tabla.id_paro) ,$tabla.id_departamento_paro, datediff ( ss, $tabla.inicio_paro , $tabla.final_paro) as diferencia from $tabla where $tabla.fecha_alta BETWEEN (SELECT CONCAT((SELECT CONVERT(VARCHAR(10), SYSDATETIME())), ' ' ,('22:30:00.000'))) AND (SELECT CONCAT((SELECT CONVERT(VARCHAR(10), SYSDATETIME())), ' ' ,('22:59:59.000'))) AND $tabla.id_area = 3 AND $tabla.id_estacion = 7 AND $tabla.id_turno = 3  AND $tabla.final_paro != '' OR $tabla.final_paro != NULL order by diferencia desc");
        $stmt -> execute();
        foreach ($stmt as $row) {
    ...
    static public function mdl_cross_30_status_TercerTurno_23_00($tabla){
    ...
    static public function mdl_cross_30_status_TercerTurno_00_01($tabla){
    ...
    static public function mdl_cross_30_status_TercerTurno_01_02($tabla){
    ...
    static public function mdl_cross_30_status_TercerTurno_02_03($tabla){
    ...
    static public function mdl_cross_30_status_TercerTurno_03_04($tabla){
    ...
    static public function mdl_cross_30_status_TercerTurno_04_05($tabla){
    ...
    static public function mdl_cross_30_status_TercerTurno_05_06($tabla){
    ...
    static public function mdl_cross_30_tiempo_paro_hora_oee($tabla){
