...
class Ajaxinsertgen_eje_70{
    ...
    public function ajaxAgregarLike_eje_70(){
        $datos = array(
        ...
        $respuesta = ControladorEje_70::ctr_insert_gen_eje_70($datos);
        echo $respuesta;
    }
...
if (isset($_POST["are"])) {
    $deseo = new Ajaxinsertgen_eje_70();
